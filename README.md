...
```bash
$ npm i --save @supernpm2024/quae-cumque-facilis-ipsa
```
...
```js
import extractDomain from '@supernpm2024/quae-cumque-facilis-ipsa';
```
...
```js
const urls = [
    'https://www.npmjs.com/package/@supernpm2024/quae-cumque-facilis-ipsa',
    'http://www.example.com:80/path/to/myfile.html?key1=value1&key2=value2#SomewhereInTheDocument',
    'http://user:password@example.com:80/path/to/myfile.html?key1=value1&key2=value2#SomewhereInTheDocument',
    'https://npmjs.com/package/@supernpm2024/quae-cumque-facilis-ipsa',
